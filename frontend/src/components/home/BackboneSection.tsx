  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto space-y-16 relative z-10">
        ...
        >
          <div className="relative aspect-[4/3] sm:aspect-[16/7] md:aspect-[21/9] w-full overflow-hidden">
            <img
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-8 flex flex-col sm:flex-row items-start sm:items-end justify-between gap-3 sm:gap-4">
            <div>
              ...
              <h3 className="text-lg sm:text-2xl font-bold uppercase text-white font-heading">
                50+ Visionaries. One Unstoppable Mission.
              </h3>
              <p className="text-xs sm:text-sm text-neutral-300 max-w-xl font-handwritten text-base sm:text-xl text-yellow-300 mt-1">
                "Together we turn impossible campus concepts into scalable ventures."
              </p>
            </div>

            <div className="flex items-center gap-3">
              <span className="text-[11px] sm:text-xs font-semibold uppercase tracking-wider text-neutral-400 bg-neutral-900/90 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full border border-neutral-700">
